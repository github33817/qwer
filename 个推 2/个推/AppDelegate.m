...
#define kGtAppId           @"A69nxAUqpM8qRp6jIGwql6"
#define kGtAppKey          @"paJniIwgQ89Y2a8x18OVc4"
#define kGtAppSecret       @"9S00hBOUah56Fiz3kyivy9"
#define BAppid @"900020523"
#define BAppkey @"V08lFiffvm4MUDSX"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL ok = [[CrashReporter sharedInstance]installWithAppId:BAppid];
    if (ok) {
        NSLog(@"成功");
    }else{
        NSLog(@"失败");
